...
class FileServiceClient extends \Grpc\BaseStub {
     ...
     */
    public function createFile(\Proto\Transaction $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/proto.FileService/createFile',
        $argument,
     ...
     * @return \Grpc\UnaryCall<\Proto\TransactionResponse>
     */
    public function updateFile(\Proto\Transaction $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/proto.FileService/updateFile',
        $argument,
        ['\Proto\TransactionResponse', 'decode'],
        $metadata, $options);
    }
     ...
     * @return \Grpc\UnaryCall<\Proto\TransactionResponse>
     */
    public function deleteFile(\Proto\Transaction $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/proto.FileService/deleteFile',
        $argument,
        ['\Proto\TransactionResponse', 'decode'],
        $metadata, $options);
    }
     ...
     * @return \Grpc\UnaryCall<\Proto\TransactionResponse>
     */
    public function appendContent(\Proto\Transaction $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/proto.FileService/appendContent',
        $argument,
        ['\Proto\TransactionResponse', 'decode'],
        $metadata, $options);
    }
     ...
     */
    public function getFileContent(\Proto\Query $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/proto.FileService/getFileContent',
        $argument,
     ...
     * @return \Grpc\UnaryCall<\Proto\Response>
     */
    public function getFileInfo(\Proto\Query $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/proto.FileService/getFileInfo',
        $argument,
        ['\Proto\Response', 'decode'],
        $metadata, $options);
    }
    ...
    public function systemDelete(\Proto\Transaction $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/proto.FileService/systemDelete',
        $argument,
        ['\Proto\TransactionResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function systemUndelete(\Proto\Transaction $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/proto.FileService/systemUndelete',
        $argument,
        ['\Proto\TransactionResponse', 'decode'],
        $metadata, $options);
    }
