 ...
 */
class ScheduleServiceClient extends \Grpc\BaseStub {
     ...
     */
    public function createSchedule(\Proto\Transaction $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/proto.ScheduleService/createSchedule',
        $argument,
     ...
     * @return \Grpc\UnaryCall<\Proto\TransactionResponse>
     */
    public function signSchedule(\Proto\Transaction $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/proto.ScheduleService/signSchedule',
        $argument,
        ['\Proto\TransactionResponse', 'decode'],
        $metadata, $options);
    }
     ...
     * @return \Grpc\UnaryCall<\Proto\TransactionResponse>
     */
    public function deleteSchedule(\Proto\Transaction $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/proto.ScheduleService/deleteSchedule',
        $argument,
        ['\Proto\TransactionResponse', 'decode'],
        $metadata, $options);
    }
     ...
     */
    public function getScheduleInfo(\Proto\Query $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/proto.ScheduleService/getScheduleInfo',
        $argument,
