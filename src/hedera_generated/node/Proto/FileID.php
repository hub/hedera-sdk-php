 ...
 *
 * Generated from protobuf message <code>proto.FileID</code>
 */
class FileID extends \Google\Protobuf\Internal\Message
{
    /**
     **
     ...
     *
     * Generated from protobuf field <code>int64 fileNum = 3;</code>
     */
    protected $fileNum = 0;
     ...
     * @return $this
     */
    public function setFileNum($var)
    {
        GPBUtil::checkInt64($var);
        $this->fileNum = $var;
