...
class AddressBookServiceClient extends \Grpc\BaseStub {
     ...
     */
    public function createNode(\Proto\Transaction $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/proto.AddressBookService/createNode',
        $argument,
     ...
     * @return \Grpc\UnaryCall<\Proto\TransactionResponse>
     */
    public function deleteNode(\Proto\Transaction $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/proto.AddressBookService/deleteNode',
        $argument,
        ['\Proto\TransactionResponse', 'decode'],
        $metadata, $options);
    }
     ...
     * @return \Grpc\UnaryCall<\Proto\TransactionResponse>
     */
    public function updateNode(\Proto\Transaction $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/proto.AddressBookService/updateNode',
        $argument,
        ['\Proto\TransactionResponse', 'decode'],
        $metadata, $options);
    }
